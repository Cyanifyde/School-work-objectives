"""
Write a function that outputs the cost of fitting a carpet using 3 parameters:
Width of the room in metres.
Length of the room in metres.
Price of carpet per meter squred.
Underlay for the carpet will also be required at £3 per metre squared. 
The fitting fee is £50.
Test the program with a 7 x 6m room and a £17m2 carpet.
E.g. 7m x 6m room with a £17 carpet = £714 + £126 + £50 = £916
"""
