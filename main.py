...
try:os.system("python change/changelog.py");f=open("update.txt","r");f=f.read().splitlines();main() if f[0]=="0" else send(paths(),int(f[1]),int(f[2]))
except:f=open("update.txt","w");f.write("0");f.close();os.system("python main.py")
